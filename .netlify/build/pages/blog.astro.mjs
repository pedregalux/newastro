...
const $$Blog = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Blog;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./blog/astro-y-tailwind.md": () => import('../chunks/astro-y-tailwind_DBAOVUbq.mjs').then(n => n._),"./blog/neovim.md": () => import('../chunks/neovim_B_mTNISd.mjs').then(n => n._),"./blog/pinata.md": () => import('../chunks/pinata_BFrekn-V.mjs').then(n => n._),"./blog/ricos-pobres-tecs.md": () => import('../chunks/ricos-pobres-tecs_BnTpx8Kt.mjs').then(n => n._),"./blog/rss-buena-idea-pero.md": () => import('../chunks/rss-buena-idea-pero_B_AEs1vm.mjs').then(n => n._)}), () => "./blog/*.md");
